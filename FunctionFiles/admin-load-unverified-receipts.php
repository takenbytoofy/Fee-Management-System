...
<style>
    ...
    .student-unverified-bills-table-display table #view-button{
        background-color: #6981d6;
        color: white;
        padding: 5px;
        width: 80px;
    ...
    .student-unverified-bills-table-display table #view-button:hover {
...
<div class="student-unverified-bills-table-display">
    ...
    <table>
        ...
        ?>
            ...
            <tr>
                <td><?php echo $unverifiedBillsData['receipt_id']; ?></td>
