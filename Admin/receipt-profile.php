...
<div class="receipt-profile-container">
    ...
    <form action="../FunctionFiles/receipt-status-change.php" method="post">
        
        <input name='recID' value=<?php echo $recID?> hidden>
        <input name='billID' value=<?php echo $billID?> hidden>
        
        <span>
            <label class="title"> Student ID: </label>
            <input type="text" name='stdID' value='<?php echo $stdID;?>' readonly><br>
        </span>
        ...
        <span>
            ...
            <input type="text" name='prgmID' value='<?php echo $prgmID;?>' readonly><br>
        </span>
                
        <span>
            <label class="title"> Enrollment Year: </label>
            <input type="text" name='enrYear' value='<?php echo $enyr;?>' readonly><br>
        </span>
        ...
        <div class='receipt-image'>
            <a href="../Admin/full-receipt-image.php?RecID=<?php echo $recID?>" target="_blank">
        ...
        <div class="buttons"> 
            <button id="accept-button" type='submit' name='decision' value='Accept'> Accept </button> 
            <button id="decline-button" type='submit' name='decision' value='Decline'> Decline</button>
        </div>
    </form>
